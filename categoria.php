            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <?php
                    // Se llama al archivo donde se tiene el procesado de la tabla productos de mi base de datos
                    include("controlador/controlador_categoria.php");
                  ?>
  ...
  <div class="modal-dialog">
    <div class="modal-content bg-danger">
      <div class="modal-header">
        <h4 class="modal-title">Error al agregar la base de datos</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body" id="desc1">
        <p>Hubo algún error al insertar los datos en la Base de Datos</p>
      </div>
